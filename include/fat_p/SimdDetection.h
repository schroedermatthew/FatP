 ...
 *
 * Compile-time macros:
 *   - FATP_SIMD_AVX512F, FATP_SIMD_AVX512BW, FATP_SIMD_AVX2, FATP_SIMD_SSE2 (x86/x64)
...
// =============================================================================
// Architecture Helpers (derived from PlatformDetection.h)
// =============================================================================

// x86 family (32-bit or 64-bit)
#if FATP_ARCH_X64 || FATP_ARCH_X86
#define FATP_SIMD_ARCH_X86_FAMILY 1
#else
#define FATP_SIMD_ARCH_X86_FAMILY 0
#endif

// ARM family (32-bit or 64-bit)
#if FATP_ARCH_ARM64 || FATP_ARCH_ARM32
#define FATP_SIMD_ARCH_ARM_FAMILY 1
#else
#define FATP_SIMD_ARCH_ARM_FAMILY 0
#endif

// =============================================================================
// x86/x64 SIMD Detection (hierarchical, from highest to lowest)
// =============================================================================
#if FATP_SIMD_ARCH_X86_FAMILY
...
#define FATP_SIMD_AVX 1
#define FATP_SIMD_SSE4_2 1
#define FATP_SIMD_SSE4_1 1
#define FATP_SIMD_SSE3 1
...
#endif // x86 SIMD levels

// GCC/Clang CPUID header (for runtime detection)
#if defined(__GNUC__) || defined(__clang__)
#include <cpuid.h>
#endif

#endif // FATP_SIMD_ARCH_X86_FAMILY

// =============================================================================
// ARM SIMD Detection
// =============================================================================
#if FATP_SIMD_ARCH_ARM_FAMILY
...
#endif // FATP_SIMD_ARCH_ARM_FAMILY

// =============================================================================
// Unified SIMD Availability
// =============================================================================
#if defined(FATP_SIMD_AVX512F) || defined(FATP_SIMD_AVX2) || defined(FATP_SIMD_AVX) || \
    defined(FATP_SIMD_SSE4_2) || defined(FATP_SIMD_SSE4_1) || defined(FATP_SIMD_SSE3) || \
    defined(FATP_SIMD_SSE2) || defined(FATP_SIMD_NEON)
...
// =============================================================================
// SIMD Level (for compatibility with code expecting FATP_SIMD_LEVEL)
// =============================================================================
#if defined(FATP_SIMD_AVX512F)
#define FATP_SIMD_LEVEL 512
#elif defined(FATP_SIMD_AVX2) || defined(FATP_SIMD_AVX)
#define FATP_SIMD_LEVEL 256
#elif defined(FATP_SIMD_SSE2) || defined(FATP_SIMD_NEON)
#define FATP_SIMD_LEVEL 128
#else
#define FATP_SIMD_LEVEL 0
#endif
 ...
 * @note On non-x86, always returns false.
 */
 ...
 * @return true if AVX-512BW is supported (requires AVX-512F).
 */
...
/**
 * @brief Get the SIMD level (128, 256, 512, or 0).
 */
constexpr int simd_level() noexcept
{
    return FATP_SIMD_LEVEL;
}
...
#elif FATP_SIMD_ARCH_ARM_FAMILY
