...
#define FATP_CONTEXTUAL_PREDICATE_N(FunctionPtr, PredicateType, N, Targets, ...)              \
    ...
    {                                                                                         \
        ...
        using FinalRaiser = FATP_CONTEXTUAL_RESOLVER(FunctionPtr, DefaultThrowingRaiser);     \
                                                                                              \
        auto enforcer = fat_p::MakeEnforcer<FinalRaiser>(PredicateType::check Targets,        \
...
#define FATP_CONTEXTUAL_ENFORCE(func_ptr, condition, ...)                                      \
    ...
    {                                                                                          \
        ...
        auto enforcer = fat_p::MakeEnforcer<FinalRaiser>((condition), #condition, FATP_LOCUS); \
        enforcer(__VA_ARGS__);                                                                 \
    } while (0)
...
#define FATP_CONTEXTUAL_ENFORCE_3(func_ptr, PredicateType, target1, target2, target3, ...) \
    FATP_CONTEXTUAL_PREDICATE_N(func_ptr, PredicateType, 3, (target1, target2, target3), __VA_ARGS__)

#define FATP_CONTEXTUAL_ENFORCE_4(func_ptr, PredicateType, target1, target2, target3, target4, ...) \
    FATP_CONTEXTUAL_PREDICATE_N(func_ptr, PredicateType, 4, (target1, target2, target3, target4), __VA_ARGS__)

#define FATP_CONTEXTUAL_ENFORCE_5(func_ptr, PredicateType, target1, target2, target3, target4, target5, ...) \
    FATP_CONTEXTUAL_PREDICATE_N(func_ptr, PredicateType, 5, (target1, target2, target3, target4, target5), __VA_ARGS__)
...
#define FATP_CONTEXTUAL_ABORT_5(func_ptr, PredicateType, target1, target2, target3, target4, target5, ...) \
...
#define FATP_CONTEXTUAL_DEBUG_5(func_ptr, PredicateType, target1, target2, target3, target4, target5, ...) \
...
#define FATP_CONTEXTUAL_ENFORCE_EXPECTED_4(func_ptr, PredicateType, target1, target2, target3, target4, ...)           \
    ([&]() -> fat_p::Expected<bool, std::string> {                                                                     \
        ...
        {                                                                                                              \
            ...
            mb.format(__VA_ARGS__);                                                                                    \
            std::string msg =                                                                                          \
                mb.get_message(FATP_LOCUS, #PredicateType "(" #target1 ", " #target2 ", " #target3 ", " #target4 ")"); \
            fat_p::detail::writeToStderr("Expected Failure: ", msg);                                                   \
            return fat_p::unexpected(msg);                                                                             \
        }                                                                                                              \
        return result;                                                                                                 \
...
#define FATP_CONTEXTUAL_ENFORCE_EXPECTED_5(func_ptr, PredicateType, target1, target2, target3, target4, target5, ...) \
    ([&]() -> fat_p::Expected<bool, std::string> {                                                                    \
        ...
        {                                                                                                             \
            fat_p::MessageBuilder mb;                                                                                 \
            mb.format(__VA_ARGS__);                                                                                   \
            std::string msg = mb.get_message(FATP_LOCUS,                                                              \
