...
7. **C++17 Compliance**: No cutting-edge features required
...
- C++17 or later
- Standard library with `<optional>` support
...
- Internal dependency: TypeTraits.h (part of same library)
...
```bash
# Copy Stringify.h and TypeTraits.h to your include directory
cp Stringify.h /your/project/include/
cp TypeTraits.h /your/project/include/
```
...
**Minimal compilation:**
```bash
g++ -std=c++17 -I/path/to/include your_file.cpp
```
...
target_compile_features(your_program PRIVATE cxx_std_17)
```
...
**Compile and run:**
```bash
g++ -std=c++17 -I/path/to/include first_program.cpp -o first_program
./first_program
```
...
**GCC:**
- Minimum: GCC 7.0
- Tested: GCC 7.5, 9.4, 10.3, 11.2, 12.1
- Recommended: GCC 9.0+

**Clang:**
- Minimum: Clang 6.0
- Tested: Clang 6.0, 10.0, 12.0, 14.0
- Recommended: Clang 10.0+

**MSVC:**
- Minimum: MSVC 2017 (19.14)
- Tested: MSVC 2017, 2019, 2022
- Recommended: MSVC 2019+

**AppleClang:**
- Minimum: AppleClang 10.0
- Tested: AppleClang 10.0, 12.0, 13.0
- Recommended: AppleClang 12.0+
...
```cpp
#include "TypeTraits.h"  // Part of same library
```
...
**Error: "if constexpr" not recognized**

```
error: 'if constexpr' only available with -std=c++17 or -std=gnu++17
```
...
# Or check if <optional> is included
#if __cplusplus >= 201703L
#include <optional>
#endif
```

**Error: TypeTraits.h not found**

```
fatal error: TypeTraits.h: No such file or directory
```

**Solution:**
```bash
# Ensure TypeTraits.h is in include path
...
**Stringify** is a comprehensive, high-performance, zero-dependency type-to-string conversion library for C++17. It provides:
...
**Resources:**
- Header: `Stringify.h`
- Dependencies: `TypeTraits.h` (internal)
- Compiler: C++17 minimum
- Documentation: This manual

---

*Stringify User Manual - Version 2.2*  
