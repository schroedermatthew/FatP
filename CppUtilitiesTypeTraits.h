/**
 * @file CppUtilitiesTypeTraits.h
 * @brief Library-specific type traits for cpp_utilities components
 *
 * @details Provides comprehensive type traits for detecting and classifying cpp_utilities
...
template <typename T, typename IndexType, typename Allocator> class CSRMatrix;
template <typename T, size_t N> class SimdVector;
template <typename T, typename Allocator> class LockFreeQueue;
...
template <typename T, size_t Alignment, typename Allocator> class AlignedVector;
 ...
 * @return Human-readable string describing whether T is Expected-like
 */
template <typename T>
std::string diagnose_expected() {
    std::ostringstream oss;
    oss << "Expected Trait Diagnosis:\n";
    oss << "  is_expected: " << std::boolalpha << is_expected_v<T> << "\n";
    oss << "  is_expected_like: " << is_expected_like_v<T> << "\n";
    oss << "  has value() method: " << is_detected_v<cpp_util_detail::value_method_t, T> << "\n";
    oss << "  has error() method: " << is_detected_v<cpp_util_detail::error_method_t, T> << "\n";
    oss << "  has error_type: " << is_detected_v<cpp_util_detail::error_type_t, T> << "\n";
    return oss.str();
}
 ...
 * @tparam T Type to diagnose
 * @return Human-readable string describing whether T is Tensor-like
 */
template <typename T>
std::string diagnose_tensor() {
    std::ostringstream oss;
    oss << "Tensor Trait Diagnosis:\n";
    oss << "  is_tensor: " << std::boolalpha << is_tensor_v<T> << "\n";
    oss << "  is_fixed_tensor: " << is_fixed_tensor_v<T> << "\n";
    oss << "  is_csr_matrix: " << is_csr_matrix_v<T> << "\n";
    oss << "  is_simd_vector: " << is_simd_vector_v<T> << "\n";
    oss << "  is_tensor_like: " << is_tensor_like_v<T> << "\n";
    oss << "  is_tensor_type (any): " << is_tensor_type_v<T> << "\n";
    oss << "  has shape() method: " << is_detected_v<cpp_util_detail::shape_t, T> << "\n";
    return oss.str();
}
 ...
 * @tparam T Type to diagnose
 * @return Human-readable string describing serialization capabilities
 */
template <typename T>
std::string diagnose_binary_serializable() {
    std::ostringstream oss;
    oss << "Binary Serialization Trait Diagnosis:\n";
    oss << "  has_binary_serialize: " << std::boolalpha << has_binary_serialize_v<T> << "\n";
    oss << "  has_binary_deserialize: " << has_binary_deserialize_v<T> << "\n";
    oss << "  is_binary_serializable (both): " << is_binary_serializable_v<T> << "\n";
    return oss.str();
}
 ...
 * @tparam T Type to diagnose
 * @return Human-readable string describing container classification
 */
template <typename T>
std::string diagnose_library_container() {
    std::ostringstream oss;
    oss << "Library Container Trait Diagnosis:\n";
    oss << "  is_small_vector: " << std::boolalpha << is_small_vector_v<T> << "\n";
    oss << "  is_circular_buffer: " << is_circular_buffer_v<T> << "\n";
    oss << "  is_flat_map: " << is_flat_map_v<T> << "\n";
    oss << "  is_flat_set: " << is_flat_set_v<T> << "\n";
    oss << "  is_sparse_set: " << is_sparse_set_v<T> << "\n";
    oss << "  is_slot_map: " << is_slot_map_v<T> << "\n";
    oss << "  is_library_container: " << is_library_container_v<T> << "\n";
    oss << "  is_concurrent_container: " << is_concurrent_container_v<T> << "\n";
    oss << "  is_small_buffer_optimized: " << is_small_buffer_optimized_v<T> << "\n";
    return oss.str();
}
