...
if(_PythonFinder_WantLibs)
    ...
    get_directory_property(_PYTHON_IMPORTED_TARGETS IMPORTED_TARGETS)
    if(ANDROID AND PYTHON::Module IN_LIST _PYTHON_IMPORTED_TARGETS)
        set_property(TARGET PYTHON::Module APPEND PROPERTY INTERFACE_LINK_LIBRARIES $<LINK_ONLY:PYTHON::Python>)
    endif()
    unset(_PYTHON_IMPORTED_TARGETS)
