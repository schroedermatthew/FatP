...
set_target_properties(Folly::folly PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/folly.lib"
  )

list(APPEND _cmake_import_check_targets Folly::folly )
list(APPEND _cmake_import_check_files_for_Folly::folly "${_IMPORT_PREFIX}/lib/folly.lib" )
...
set_target_properties(Folly::folly_test_util PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/folly_test_util.lib"
  )

list(APPEND _cmake_import_check_targets Folly::folly_test_util )
list(APPEND _cmake_import_check_files_for_Folly::folly_test_util "${_IMPORT_PREFIX}/lib/folly_test_util.lib" )
...
set_target_properties(Folly::follybenchmark PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/follybenchmark.lib"
  )

list(APPEND _cmake_import_check_targets Folly::follybenchmark )
list(APPEND _cmake_import_check_files_for_Folly::follybenchmark "${_IMPORT_PREFIX}/lib/follybenchmark.lib" )
