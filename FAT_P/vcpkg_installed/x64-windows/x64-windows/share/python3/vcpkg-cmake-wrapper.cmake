...
if(_PythonFinder_WantLibs)
    ...
    get_directory_property(_Python3_IMPORTED_TARGETS IMPORTED_TARGETS)
    if(ANDROID AND Python3::Module IN_LIST _Python3_IMPORTED_TARGETS)
        set_property(TARGET Python3::Module APPEND PROPERTY INTERFACE_LINK_LIBRARIES $<LINK_ONLY:Python3::Python>)
    endif()
    unset(_Python3_IMPORTED_TARGETS)
