...
struct DefaultOpPolicy
{
    ...
    {
        return checked_and(lhs, rhs);
    }
    static constexpr U bit_or(U lhs, U rhs)
    {
        return checked_or(lhs, rhs);
    }
    static constexpr U bit_xor(U lhs, U rhs)
    {
        return checked_xor(lhs, rhs);
    }
    ...
    {
        return checked_left_shift(lhs, rhs);
    }
    static constexpr U right_shift(U lhs, U rhs)
    {
        return checked_right_shift(lhs, rhs);
    }
};
...
public:
    ...
    // Binary Ops
    [[nodiscard]] constexpr friend StrongId operator+(StrongId lhs, const StrongId& rhs)
    {
        return lhs += rhs;
    }
    [[nodiscard]] constexpr friend StrongId operator+(StrongId lhs, T rhs)
    {
        return lhs += rhs;
    }
    [[nodiscard]] constexpr friend StrongId operator-(StrongId lhs, const StrongId& rhs)
