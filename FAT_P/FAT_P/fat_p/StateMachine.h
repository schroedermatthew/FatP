...
namespace fat_p {
    ...
    using HasNoexceptEntry = std::integral_constant<bool, noexcept(std::declval<State>().on_entry(std::declval<Context&>()))>;
    ...
    struct are_unique<T, Ts...> : std::conjunction<
    ...
    public:
        StateMachine(Context& context) : context_(context), currentStateIndex_(InitialIndex) {
