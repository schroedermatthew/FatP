...
TEST_CASE(fuzz_ints)
{
    ...
    for (int i = 0; i < 2000; ++i)
    {
        ...
        int result = 0;
        ASSERT_TRUE(fuzz_roundtrip(v, result), "Fuzz int roundtrip failed");
        ASSERT_TRUE(result == v, "Fuzz int mismatch");
    }
...
TEST_CASE(fuzz_int64)
{
    ...
    for (int i = 0; i < 2000; ++i)
    {
        ...
        ASSERT_TRUE(fuzz_roundtrip(v, result), "Fuzz int64 roundtrip failed");
        ASSERT_TRUE(result == v, "Fuzz int64 mismatch");
    }
...
TEST_CASE(fuzz_doubles)
{
    ...
    for (int i = 0; i < 2000; ++i)
    {
        ...
        double result = 0.0;
        ASSERT_TRUE(fuzz_roundtrip(v, result), "Fuzz double roundtrip failed");
        ASSERT_TRUE(std::fabs(result - v) < 1e-9, "Fuzz double mismatch");
    }
...
TEST_CASE(fuzz_strings)
{
    ...
    for (int i = 0; i < 2000; ++i)
    {
        ...
        std::string result;
        ASSERT_TRUE(fuzz_roundtrip(v, result), "Fuzz string roundtrip failed");
        ASSERT_TRUE(result == v, "Fuzz string mismatch");
    }
...
TEST_CASE(fuzz_vector_int)
{
    ...
    for (int iter = 0; iter < 500; ++iter)
    {
        ...
        std::vector<int> result;
        ASSERT_TRUE(fuzz_roundtrip(v, result), "Fuzz vector<int> roundtrip failed");
        ASSERT_TRUE(result == v, "Fuzz vector<int> mismatch");
    }
...
TEST_CASE(fuzz_map_string_int)
{
    ...
    for (int iter = 0; iter < 300; ++iter)
    {
        ...
        std::map<std::string, int> result;
        ASSERT_TRUE(fuzz_roundtrip(m, result), "Fuzz map<string,int> roundtrip failed");
        ASSERT_TRUE(result == m, "Fuzz map<string,int> mismatch");
    }
...
TEST_CASE(fuzz_nested_structures)
{
    ...
    for (int iter = 0; iter < 200; ++iter)
    {
        ...
        ASSERT_TRUE(fuzz_roundtrip(v, result), "Fuzz nested roundtrip failed");
        ASSERT_TRUE(result == v, "Fuzz nested vector<map<string,int>> mismatch");
    }
