...
void run_hpc_vector_benchmarks()
{
    ...
    out << "\n"
        << colors::cyan() << colors::bold() << "=== HpcVector vs std::vector Performance ===" << colors::reset()
        << "\n\n";

    const size_t N = 1000000;

    out << colors::blue() << "--- Allocation (1M elements) ---" << colors::reset() << "\n";
    ...
    out << "\n" << colors::blue() << "--- Sequential Write (1M elements) ---" << colors::reset() << "\n";
    ...
    out << "\n" << colors::blue() << "--- Sum Reduction (1M elements) ---" << colors::reset() << "\n";
    ...
    out << "  NUMA available: " << (memory::NumaInfo::is_available() ? "yes" : "no") << "\n";
