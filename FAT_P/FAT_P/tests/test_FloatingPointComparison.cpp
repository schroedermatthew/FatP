...
void benchmark_policy_standard(const BenchmarkData& data)
{
    ...
    benchmark_detailed(
        ...
        [&]()
        {
            ...
            {
                result = floatEqual(data.values_normal[i], data.values_normal[i + 1], 1e-9);
            }
            return result;
        },
        1000);
    ...
    benchmark_detailed(
        ...
        [&]()
        {
            ...
            {
                result = floatEqual(data.values_near_zero[i], data.values_near_zero[i + 1], 1e-12);
            }
            return result;
        },
        1000);
...
void benchmark_policy_relative(const BenchmarkData& data)
{
    ...
    benchmark_detailed(
        ...
        [&]()
        {
            ...
            for (size_t i = 0; i < data.values_normal.size() - 1; ++i)
            {
                result = floatEqual<double, RelativeComparisonPolicy>(data.values_normal[i],
...
void benchmark_policy_ulp(const BenchmarkData& data)
{
    ...
    benchmark_detailed(
        ...
        [&]()
        {
            ...
            for (size_t i = 0; i < data.values_normal.size() - 1; ++i)
            {
                result = floatEqual<double, UlpComparisonPolicy>(data.values_normal[i], data.values_normal[i + 1], 4.0);
            }
            return result;
        },
        1000);
...
void benchmark_policy_hybrid(const BenchmarkData& data)
{
    ...
    benchmark_detailed(
        ...
        [&]()
        {
            ...
            for (size_t i = 0; i < data.values_normal.size() - 1; ++i)
            {
                result = approximateEqual(data.values_normal[i], data.values_normal[i + 1], 1e-9, 1e-12);
            }
            return result;
        },
        1000);
    ...
    benchmark_detailed(
        ...
        [&]()
        {
            ...
            {
                result = approximateEqual(data.values_mixed[i], data.values_mixed[i + 1], 1e-6, 1e-12);
            }
            return result;
        },
        1000);
