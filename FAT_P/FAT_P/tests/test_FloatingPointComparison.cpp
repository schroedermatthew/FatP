...
FATP_META:
  ...
  file_role: test
  path: tests/test_FloatingPointComparison.cpp
  namespace: fat_p
...
TEST_CASE(standard_boundary_values)
{
        constexpr double eps = getDefaultEpsilon<double>();
        double a = 1.0;
...
TEST_CASE(standard_negative_values)
{
        constexpr double eps = getDefaultEpsilon<double>();
...
TEST_CASE(standard_special_values)
{
...
TEST_CASE(standard_zero_comparisons)
{
        double zero = 0.0;
...
TEST_CASE(ulp_exact_boundaries)
{
        float a = 1.0f;
...
TEST_CASE(ulp_subnormal_boundaries)
{
...
TEST_CASE(ulp_sign_sensitivity)
{
    ...
    // =============================================================================
TEST_CASE(relative_scale_independence)
{
        double rel_eps = 1e-6;
...
TEST_CASE(relative_near_zero_weakness)
{
        double rel_eps = 1e-6;
...
TEST_CASE(relative_default_epsilon)
{
        double a = 1.0;
...
TEST_CASE(relative_zero_comparisons)
{
...
TEST_CASE(hybrid_near_zero_robustness)
{
        double rel_eps = 1e-6;
        double abs_eps = 1e-12;
...
TEST_CASE(hybrid_parameter_flexibility)
{
...
TEST_CASE(hybrid_boundary_conditions)
{
        double rel_eps = 1e-6;
        double abs_eps = 1e-12;
...
TEST_CASE(policy_consistency_on_special_values)
{
        constexpr double pos_inf = std::numeric_limits<double>::infinity();
        constexpr double neg_inf = -std::numeric_limits<double>::infinity();
        constexpr double nan = std::numeric_limits<double>::quiet_NaN();
...
TEST_CASE(scale_transition_points)
{
    ...
    // =============================================================================
TEST_CASE(mixed_signs_noise_floor)
{
...
TEST_CASE(near_zero_crossing_stability)
{
    ...
    // =============================================================================
TEST_CASE(approximate_equal_basic)
{
...
TEST_CASE(approximate_equal_types)
{
...
TEST_CASE(approximate_equal_zero_handling)
{
        double zero = 0.0;
        double tiny = 1e-14;
        double eps = 1e-12;
...
TEST_CASE(epsilon_type_correctness)
{
...
TEST_CASE(consecutive_values)
{
    ...
    // =============================================================================
TEST_CASE(long_double_comprehensive)
{
        constexpr long double ld_eps = getDefaultEpsilon<long double>();
...
TEST_CASE(long_double_precision)
{
    ...
    // =============================================================================
TEST_CASE(control_system_noise)
{
...
bool test_FloatingPointComparison()
{
    ...
    RUN_TEST_NS(runner, floatingpointcomparison, standard_basic);
    RUN_TEST_NS(runner, floatingpointcomparison, standard_boundary_values);
    RUN_TEST_NS(runner, floatingpointcomparison, standard_negative_values);
    RUN_TEST_NS(runner, floatingpointcomparison, standard_special_values);
    RUN_TEST_NS(runner, floatingpointcomparison, standard_zero_comparisons);

    std::cout << "\n=== UlpComparisonPolicy ===" << std::endl;
    RUN_TEST_NS(runner, floatingpointcomparison, ulp_basic);
    RUN_TEST_NS(runner, floatingpointcomparison, ulp_exact_boundaries);
    RUN_TEST_NS(runner, floatingpointcomparison, ulp_negative_values);
    RUN_TEST_NS(runner, floatingpointcomparison, ulp_subnormals);
    RUN_TEST_NS(runner, floatingpointcomparison, ulp_subnormal_boundaries);
    RUN_TEST_NS(runner, floatingpointcomparison, ulp_sign_sensitivity);

    std::cout << "\n=== RelativeComparisonPolicy ===" << std::endl;
    RUN_TEST_NS(runner, floatingpointcomparison, relative_scale_independence);
    RUN_TEST_NS(runner, floatingpointcomparison, relative_near_zero_weakness);
    RUN_TEST_NS(runner, floatingpointcomparison, relative_default_epsilon);
    RUN_TEST_NS(runner, floatingpointcomparison, relative_zero_comparisons);

    std::cout << "\n=== HybridComparisonPolicy ===" << std::endl;
    RUN_TEST_NS(runner, floatingpointcomparison, hybrid_robustness);
    RUN_TEST_NS(runner, floatingpointcomparison, hybrid_near_zero_robustness);
    RUN_TEST_NS(runner, floatingpointcomparison, hybrid_parameter_flexibility);
    RUN_TEST_NS(runner, floatingpointcomparison, hybrid_boundary_conditions);

    std::cout << "\n=== Cross-Policy Verification ===" << std::endl;
    RUN_TEST_NS(runner, floatingpointcomparison, policy_differences);
    RUN_TEST_NS(runner, floatingpointcomparison, policy_consistency_on_special_values);
    RUN_TEST_NS(runner, floatingpointcomparison, scale_transition_points);

    std::cout << "\n=== Mixed-Sign Edge Cases ===" << std::endl;
    RUN_TEST_NS(runner, floatingpointcomparison, mixed_signs_noise_floor);
    RUN_TEST_NS(runner, floatingpointcomparison, near_zero_crossing_stability);

    std::cout << "\n=== approximateEqual Convenience Function ===" << std::endl;
    RUN_TEST_NS(runner, floatingpointcomparison, approximate_equal_basic);
    RUN_TEST_NS(runner, floatingpointcomparison, approximate_equal_types);
    RUN_TEST_NS(runner, floatingpointcomparison, approximate_equal_zero_handling);

    std::cout << "\n=== Type-Specific Default Epsilons ===" << std::endl;
    RUN_TEST_NS(runner, floatingpointcomparison, default_epsilons);
    RUN_TEST_NS(runner, floatingpointcomparison, epsilon_type_correctness);

    std::cout << "\n=== Edge Cases and Stress Tests ===" << std::endl;
    RUN_TEST_NS(runner, floatingpointcomparison, extreme_values);
    RUN_TEST_NS(runner, floatingpointcomparison, denormal_numbers);
    RUN_TEST_NS(runner, floatingpointcomparison, pathological_cases);
    RUN_TEST_NS(runner, floatingpointcomparison, consecutive_values);

    std::cout << "\n=== Long Double Comprehensive Testing ===" << std::endl;
    RUN_TEST_NS(runner, floatingpointcomparison, long_double_comprehensive);
    RUN_TEST_NS(runner, floatingpointcomparison, long_double_precision);

    std::cout << "\n=== Control System Simulation ===" << std::endl;
    RUN_TEST_NS(runner, floatingpointcomparison, control_system_noise);

#ifndef NDEBUG
    std::cout << "\n[Debug build - skipping benchmarks]\n";
#else
    fat_p::testing::floatingpointcomparison::run_benchmarks();
#endif
