...
FATP_TEST_CASE(trait_return_type_checking) {
    ...
    FATP_ASSERT_TRUE(has_to_string_method_v<CustomStringifiable>, 
                  "Should detect valid toString()");
    FATP_ASSERT_TRUE(has_to_string_snake_method_v<CustomStringifiable2>, 
                  "Should detect valid to_string()");
    
    // Invalid return types should NOT be detected
    FATP_ASSERT_TRUE(!has_to_string_method_v<BadToString>, 
    ...
    FATP_ASSERT_TRUE(!has_to_string_method_v<NonStreamable>, 
...
FATP_TEST_CASE(integer_fast_path_performance) {
    ...
    FATP_ASSERT_TRUE(optimized_ns / baseline_ns < 2.0, 
...
FATP_TEST_CASE(float_fast_path) {
    ...
    FATP_ASSERT_TRUE(result.find("e") != std::string::npos || 
    ...
    FATP_ASSERT_TRUE(fast_ns / baseline_ns < 2.0, 
...
FATP_TEST_CASE(container_options) {
    ...
    FATP_ASSERT_TRUE(depth_str.find("<max depth>") != std::string::npos, 
...
FATP_TEST_CASE(recursion_depth_guard) {
    ...
    FATP_ASSERT_TRUE(result.find("<max depth>") != std::string::npos, 
...
FATP_TEST_CASE(classic_locale_default) {
    ...
    FATP_ASSERT_TRUE(result.find(".") != std::string::npos, 
...
FATP_TEST_CASE(error_reporting) {
    ...
    FATP_ASSERT_TRUE(error.find("Intentional") != std::string::npos, 
...
FATP_TEST_CASE(is_stringifiable_trait) {
    ...
    // Custom types
    FATP_ASSERT_TRUE(is_stringifiable_v<CustomStringifiable>, 
                  "Custom with toString() should be stringifiable");
    FATP_ASSERT_TRUE(is_stringifiable_v<CustomStringifiable2>, 
                  "Custom with to_string() should be stringifiable");
    FATP_ASSERT_TRUE(is_stringifiable_v<CustomWithStreamOp>, 
                  "Custom with operator<< should be stringifiable");
    
    // Containers
    FATP_ASSERT_TRUE(is_stringifiable_v<std::vector<int>>, 
                  "vector should be stringifiable");
    FATP_ASSERT_TRUE((is_stringifiable_v<std::map<std::string, int>>), 
                  "map should be stringifiable");
    
    // Pair and tuple
    FATP_ASSERT_TRUE((is_stringifiable_v<std::pair<int, int>>), 
                  "pair should be stringifiable");
    FATP_ASSERT_TRUE((is_stringifiable_v<std::tuple<int, double>>), 
                  "tuple should be stringifiable");
    
    // Optional
    FATP_ASSERT_TRUE(is_stringifiable_v<std::optional<int>>, 
                  "optional should be stringifiable");
    
    // Non-stringifiable
    FATP_ASSERT_TRUE(!is_stringifiable_v<NonStreamable>, 
...
FATP_TEST_CASE(complete_api_surface) {
    ...
    FATP_ASSERT_TRUE(ptr_str.find("0x") != std::string::npos || 
...
FATP_TEST_CASE(edge_case_type_detection) {
    ...
    FATP_ASSERT_TRUE(iwts_str.find("custom") != std::string::npos,
