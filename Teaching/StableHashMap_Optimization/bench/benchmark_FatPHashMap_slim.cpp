/**
 * @file benchmark_FatPHashMap_Slim.cpp
 ...
 *   2. Miss diagnostics (slim)
 *   3. Pathological erase (tombstone degradation test)
...
#include "StableHashMap_optionB.h"
...
int main(int argc, char* argv[])
{
    ...
    std::cout << "Stability detection: frequency variance < 10% AND >= 60% of "
                 "base (under load)\n\n";
