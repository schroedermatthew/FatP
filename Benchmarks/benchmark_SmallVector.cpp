/**
 * @file benchmark_SmallVector.cpp
 * @brief Comprehensive benchmark suite for SmallVector
 *
 ...
 *
 * Compile (minimal - SmallVector only):
 *   g++ -std=c++17 -O3 -DNDEBUG -march=native -I. \
 *       benchmark_SmallVector.cpp -o benchmark_SmallVector
 *
 * Compile (with Boost - auto-detected via __has_include):
 *   g++ -std=c++17 -O3 -DNDEBUG -march=native -I. -I/path/to/boost \
 *       benchmark_SmallVector.cpp -o benchmark_SmallVector
 *
...
#if __has_include(<folly/small_vector.h>)
