...
#include "test_CSRMatrix_HPC_Parallel.h"
#include "test_CSRMatrixParallel.h"
...
#include "test_TensorComparison.h"
...
#define RUN_AND_RECORD(test_func) \
    ...
    //RUN_AND_RECORD(test_SwissTable);
