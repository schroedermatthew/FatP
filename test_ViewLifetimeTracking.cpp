...
bool test_dangling_reference_detection() {
    ...
    
    {
        ...
        SIMPLE_ASSERT(view->is_valid(), "View should be valid while object exists");
    }
    // data and tracker destroyed here
    
    SIMPLE_ASSERT(!view->is_valid(), "View should be invalid after object destroyed");
    ...
    try {
        ...
        SIMPLE_ASSERT(msg.find("Dangling reference") != std::string::npos,
...
bool test_multiple_views() {
    ...
    SIMPLE_ASSERT(view1.is_valid(), "View 1 should be valid");
    SIMPLE_ASSERT(view2.is_valid(), "View 2 should be valid");
    SIMPLE_ASSERT(view3.is_valid(), "View 3 should be valid");
    
    SIMPLE_ASSERT((*view1)[0] == 10, "View 1 should access data");
...
bool test_weak_pointer_utilities() {
    ...
    
    {
        ...
        SIMPLE_ASSERT(*locked == 42, "Locked pointer should have correct value");
    }
    ...
    SIMPLE_ASSERT(threw, "Expired weak pointer should throw");
...
bool test_view_guard() {
    ...
    
    {
        ...
        SIMPLE_ASSERT(view.is_valid(), "View should be valid in guard scope");
    }
...
bool test_zero_overhead_release() {
    ...
    std::cout << colors::blue() << "  Tracker size: " << sizeof(TrackerType) 
