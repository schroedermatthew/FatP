...
using cbor_stream::StreamError;
using cbor_stream::StreamResult;
using cbor_stream::FatPStreamParser;
using cbor_stream::DefaultStreamParser;
using cbor_stream::StrictStreamParser;
using cbor_stream::RelaxedStreamParser;
using cbor_stream::ValidatingStreamParser;
using cbor_stream::ConfigurableStreamParser;
using cbor_stream::DefaultLimitsPolicy;
using cbor_stream::StrictLimitsPolicy;
using cbor_stream::RelaxedLimitsPolicy;
using cbor_stream::RuntimeLimitsPolicy;
using cbor_stream::NoValidationPolicy;
using cbor_stream::Utf8ValidationPolicy;
using cbor_stream::StrictValidationPolicy;
using cbor_stream::stream_parse;
using cbor_stream::stream_parse_strict;
using cbor_stream::stream_parse_limited;

/**
 * @brief Macro to bring FatPCborStream types into local scope
 */
#define USING_FATP_CBOR_STREAM()                                     \
    using fat_p::StreamError;                                        \
    using fat_p::StreamResult;                                       \
    using fat_p::FatPStreamParser;                                   \
    using fat_p::DefaultStreamParser;                                \
    using fat_p::StrictStreamParser;                                 \
    using fat_p::RelaxedStreamParser;                                \
    using fat_p::ValidatingStreamParser;                             \
    using fat_p::ConfigurableStreamParser;                           \
    using fat_p::DefaultLimitsPolicy;                                \
    using fat_p::StrictLimitsPolicy;                                 \
    using fat_p::RelaxedLimitsPolicy;                                \
    using fat_p::RuntimeLimitsPolicy;                                \
    using fat_p::NoValidationPolicy;                                 \
    using fat_p::Utf8ValidationPolicy;                               \
    using fat_p::StrictValidationPolicy;                             \
    using fat_p::stream_parse;                                       \
    using fat_p::stream_parse_strict;                                \
    using fat_p::stream_parse_limited;                               \
