...
TEST_CASE(json_lite_basic_types)
{
    SUBTEST("null type") {
        ...
        ASSERT_EQ(str, "null", "Null should serialize to 'null'");
    }
    END_SUBTEST
    
    SUBTEST("boolean types") {
        JsonValue j_true = true;
        JsonValue j_false = false;
        ASSERT_TRUE(j_true.is_bool(), "Should be bool");
        ASSERT_EQ(to_json_string(j_true), "true", "True should serialize to 'true'");
        ASSERT_EQ(to_json_string(j_false), "false", "False should serialize to 'false'");
    }
    END_SUBTEST
    
    SUBTEST("numeric types") {
        JsonValue j_int = static_cast<int64_t>(42);
        JsonValue j_float = 3.14159;
        ASSERT_TRUE(j_int.is_int(), "Should be int");
        ASSERT_TRUE(j_float.is_number(), "Should be number");
        ASSERT_EQ(to_json_string(j_int), "42", "Int should serialize correctly");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_int8)
{
    SUBTEST("int8_t serialization") {
        ...
        ASSERT_TRUE(j.is_int(), "int8_t should be int");
        ASSERT_EQ(std::get<int64_t>(j), static_cast<int64_t>(127), "Value should be 127");
    }
    END_SUBTEST
    
    SUBTEST("int8_t deserialization") {
        JsonValue j = static_cast<int64_t>(42);
        int8_t result = 0;
        from_json(j, result);
        ASSERT_EQ(result, static_cast<int8_t>(42), "Value should be 42");
    }
    END_SUBTEST
    
    SUBTEST("int8_t range check") {
        JsonValue j = static_cast<int64_t>(1000);
        int8_t result = 0;
        ASSERT_THROWS(from_json(j, result), std::runtime_error, "Should throw on overflow");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_int16)
{
    SUBTEST("int16_t serialization") {
        int16_t val = 32767;
        JsonValue j = to_json(val);
        ASSERT_EQ(std::get<int64_t>(j), static_cast<int64_t>(32767), "Value should be 32767");
    }
    END_SUBTEST
    
    SUBTEST("int16_t deserialization") {
        JsonValue j = static_cast<int64_t>(1000);
        int16_t result = 0;
        from_json(j, result);
        ASSERT_EQ(result, static_cast<int16_t>(1000), "Value should be 1000");
    }
    END_SUBTEST
    
    SUBTEST("int16_t range check") {
...
TEST_CASE(json_lite_int32)
{
    SUBTEST("int32_t serialization") {
        int val = 2147483647;
        JsonValue j = to_json(val);
        ASSERT_EQ(std::get<int64_t>(j), static_cast<int64_t>(2147483647), "Value should be INT_MAX");
    }
    END_SUBTEST
    
    SUBTEST("int32_t deserialization") {
        JsonValue j = static_cast<int64_t>(100000);
        int result = 0;
        from_json(j, result);
        ASSERT_EQ(result, 100000, "Value should be 100000");
    }
    END_SUBTEST
    
    SUBTEST("int32_t range check") {
...
TEST_CASE(json_lite_int64)
{
    SUBTEST("int64_t serialization") {
        ...
        JsonValue j = to_json(val);
        ASSERT_EQ(std::get<int64_t>(j), val, "Value should be LLONG_MAX");
    }
    END_SUBTEST
    
    SUBTEST("int64_t deserialization") {
        JsonValue j = static_cast<int64_t>(9223372036854775807LL);
        int64_t result = 0;
        from_json(j, result);
        ASSERT_EQ(result, 9223372036854775807LL, "Value should be LLONG_MAX");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_uint8)
{
    SUBTEST("uint8_t serialization") {
        uint8_t val = 255;
        JsonValue j = to_json(val);
        ASSERT_EQ(std::get<int64_t>(j), static_cast<int64_t>(255), "Value should be 255");
    }
    END_SUBTEST
    
    SUBTEST("uint8_t deserialization") {
        JsonValue j = static_cast<int64_t>(200);
        uint8_t result = 0;
        from_json(j, result);
        ASSERT_EQ(result, static_cast<uint8_t>(200), "Value should be 200");
    }
    END_SUBTEST
    
    SUBTEST("uint8_t range check") {
        JsonValue j = static_cast<int64_t>(1000);
        uint8_t result = 0;
        ASSERT_THROWS(from_json(j, result), std::runtime_error, "Should throw on overflow");
    }
    ...
    SUBTEST("uint8_t negative check") {
        JsonValue j = static_cast<int64_t>(-1);
        uint8_t result = 0;
        ASSERT_THROWS(from_json(j, result), std::runtime_error, "Should throw on negative value");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_uint16)
{
    SUBTEST("uint16_t serialization") {
        uint16_t val = 65535;
        JsonValue j = to_json(val);
        ASSERT_EQ(std::get<int64_t>(j), static_cast<int64_t>(65535), "Value should be 65535");
    }
    END_SUBTEST
    
    SUBTEST("uint16_t deserialization") {
        JsonValue j = static_cast<int64_t>(60000);
        uint16_t result = 0;
        from_json(j, result);
        ASSERT_EQ(result, static_cast<uint16_t>(60000), "Value should be 60000");
    }
    END_SUBTEST
    
    SUBTEST("uint16_t range check") {
        JsonValue j = static_cast<int64_t>(100000);
        uint16_t result = 0;
        ASSERT_THROWS(from_json(j, result), std::runtime_error, "Should throw on overflow");
    }
...
TEST_CASE(json_lite_uint32)
{
    SUBTEST("uint32_t serialization") {
        ...
        JsonValue j = to_json(val);
        ASSERT_EQ(std::get<int64_t>(j), static_cast<int64_t>(4294967295U), "Value should be UINT_MAX");
    }
    END_SUBTEST
    
    SUBTEST("uint32_t deserialization") {
        JsonValue j = static_cast<int64_t>(4000000000LL);
        unsigned int result = 0;
        from_json(j, result);
        ASSERT_EQ(result, 4000000000U, "Value should be 4000000000");
    }
    END_SUBTEST
    
    SUBTEST("uint32_t range check") {
...
TEST_CASE(json_lite_uint64)
{
    SUBTEST("uint64_t serialization large value") {
        ...
        JsonValue j = to_json(val);
        ASSERT_TRUE(j.is_number(), "Large uint64_t should be number");
    }
    END_SUBTEST
    
    SUBTEST("uint64_t deserialization") {
        JsonValue j = static_cast<int64_t>(1000000000LL);
        unsigned long long result = 0;
        from_json(j, result);
        ASSERT_EQ(result, 1000000000ULL, "Value should be 1000000000");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_float_types)
{
    SUBTEST("float serialization") {
        float val = 3.14f;
        JsonValue j = to_json(val);
        ASSERT_TRUE(j.is_number(), "Float should be number");
    }
    END_SUBTEST
    
    SUBTEST("double serialization") {
        double val = 2.718281828459045;
        JsonValue j = to_json(val);
        ASSERT_TRUE(j.is_number(), "Double should be number");
    }
    END_SUBTEST
    
    SUBTEST("float deserialization") {
        JsonValue j = 3.14;
        float result = 0.0f;
        from_json(j, result);
        ASSERT_CLOSE(result, 3.14f, "Value should be close to 3.14");
    }
    END_SUBTEST
    
    SUBTEST("double deserialization") {
        JsonValue j = 2.718281828459045;
        double result = 0.0;
        from_json(j, result);
        ASSERT_CLOSE(result, 2.718281828459045, "Value should be close to e");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_numeric_edge_cases)
{
    SUBTEST("very large double") {
        ...
        double result = 0.0;
        from_json(j, result);
        ASSERT_CLOSE(result, val, "Large double should round-trip");
    }
    END_SUBTEST
    
    SUBTEST("very small double") {
        double val = 2.2250738585072014e-308;
        JsonValue j = to_json(val);
        double result = 0.0;
        from_json(j, result);
        ASSERT_CLOSE(result, val, "Small double should round-trip");
    }
    END_SUBTEST
    
    SUBTEST("negative zero") {
        double val = -0.0;
        JsonValue j = to_json(val);
        ASSERT_TRUE(j.is_number(), "Negative zero should be number");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_fixed_width_int8)
{
    ...
    int8_t result = 0;
    from_json(j, result);
    ASSERT_EQ(result, val, "int8_t min should round-trip");
    
    val = 127;
    j = to_json(val);
    from_json(j, result);
    ASSERT_EQ(result, val, "int8_t max should round-trip");
...
TEST_CASE(json_lite_fixed_width_int16)
{
    ...
    int16_t result = 0;
    from_json(j, result);
    ASSERT_EQ(result, val, "int16_t min should round-trip");
    
    val = 32767;
    j = to_json(val);
    from_json(j, result);
    ASSERT_EQ(result, val, "int16_t max should round-trip");
...
TEST_CASE(json_lite_fixed_width_int32)
{
    ...
    int32_t result = 0;
    from_json(j, result);
    ASSERT_EQ(result, val, "int32_t min should round-trip");
    
    val = 2147483647;
    j = to_json(val);
    from_json(j, result);
    ASSERT_EQ(result, val, "int32_t max should round-trip");
...
TEST_CASE(json_lite_fixed_width_int64)
{
    ...
    int64_t result = 0;
    from_json(j, result);
    ASSERT_EQ(result, val, "int64_t min should round-trip");
    
    val = LLONG_MAX;
    j = to_json(val);
    from_json(j, result);
    ASSERT_EQ(result, val, "int64_t max should round-trip");
...
TEST_CASE(json_lite_fixed_width_uint8)
{
    ...
    uint8_t result = 1;
    from_json(j, result);
    ASSERT_EQ(result, val, "uint8_t min should round-trip");
    
    val = 255;
    j = to_json(val);
    from_json(j, result);
    ASSERT_EQ(result, val, "uint8_t max should round-trip");
...
TEST_CASE(json_lite_fixed_width_uint16)
{
    ...
    uint16_t result = 1;
    from_json(j, result);
    ASSERT_EQ(result, val, "uint16_t min should round-trip");
    
    val = 65535;
    j = to_json(val);
    from_json(j, result);
    ASSERT_EQ(result, val, "uint16_t max should round-trip");
...
TEST_CASE(json_lite_fixed_width_uint32)
{
    ...
    uint32_t result = 1;
    from_json(j, result);
    ASSERT_EQ(result, val, "uint32_t min should round-trip");
    
    val = 4294967295U;
    j = to_json(val);
    from_json(j, result);
    ASSERT_EQ(result, val, "uint32_t max should round-trip");
...
TEST_CASE(json_lite_fixed_width_uint64)
{
    ...
    uint64_t result = 1;
    from_json(j, result);
    ASSERT_EQ(result, val, "uint64_t min should round-trip");
    
    val = static_cast<uint64_t>(LLONG_MAX);
    j = to_json(val);
    from_json(j, result);
    ASSERT_EQ(result, val, "uint64_t in range should round-trip");
...
TEST_CASE(json_lite_string_escaping)
{
    SUBTEST("basic escaping") {
        ...
        ASSERT_TRUE(json_str.find("\\\"") != std::string::npos, "Quotes should be escaped");
    }
    END_SUBTEST
    
    SUBTEST("newline escaping") {
    ...
    SUBTEST("control characters") {
        std::string val = "Tab:\tBackspace:\b";
        JsonValue j = to_json(val);
        std::string json_str = to_json_string(j);
        ASSERT_TRUE(json_str.find("\\t") != std::string::npos, "Tab should be escaped");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_string_empty)
{
    ...
    std::string result;
    from_json(j, result);
    ASSERT_EQ(result, "", "Empty string should round-trip");
...
TEST_CASE(json_lite_string_whitespace)
{
    ...
    std::string result;
    from_json(j, result);
    ASSERT_EQ(result, val, "Whitespace should be preserved");
...
TEST_CASE(json_lite_string_special_chars)
{
    ...
    std::string result;
    from_json(j, result);
    ASSERT_TRUE(!result.empty(), "Special chars should survive");
...
TEST_CASE(json_lite_string_unicode)
{
    SUBTEST("basic unicode") {
        ...
        JsonValue j = to_json(val);
        std::string json_str = to_json_string(j);
        ASSERT_TRUE(!json_str.empty(), "Unicode should be handled");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_string_long)
{
    ...
    std::string result;
    from_json(j, result);
    ASSERT_EQ(result.size(), val.size(), "Long string should preserve length");
...
TEST_CASE(json_lite_containers)
{
    SUBTEST("vector<int>") {
        ...
        ASSERT_TRUE(j.is_array(), "Vector should be array");
        std::vector<int> result;
        from_json(j, result);
        ASSERT_EQ(result.size(), vec.size(), "Vector size should match");
        ASSERT_EQ(result[0], 1, "First element should be 1");
        ASSERT_EQ(result[4], 5, "Last element should be 5");
    }
    END_SUBTEST
    
    SUBTEST("map<string, int>") {
        std::map<std::string, int> m = {{"one", 1}, {"two", 2}, {"three", 3}};
        JsonValue j = to_json(m);
        ASSERT_TRUE(j.is_object(), "Map should be object");
        std::map<std::string, int> result;
        from_json(j, result);
        ASSERT_EQ(result.size(), m.size(), "Map size should match");
        ASSERT_EQ(result["one"], 1, "Value for 'one' should be 1");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_vector_single)
{
    ...
    std::vector<int> result;
    from_json(j, result);
    ASSERT_EQ(result.size(), static_cast<size_t>(1), "Size should be 1");
    ASSERT_EQ(result[0], 42, "Value should be 42");
...
TEST_CASE(json_lite_set)
{
    ...
    std::set<int> result;
    from_json(j, result);
    ASSERT_EQ(result.size(), s.size(), "Set size should match");
    ASSERT_TRUE(result.count(3) == 1, "Should contain 3");
...
TEST_CASE(json_lite_nested_vectors)
{
    ...
    from_json(j, result);
    ASSERT_EQ(result.size(), nested.size(), "Outer size should match");
    ASSERT_EQ(result[0].size(), static_cast<size_t>(2), "Inner size should be 2");
    ASSERT_EQ(result[1][1], 4, "Element should be 4");
...
TEST_CASE(json_lite_mixed_nested)
{
    ...
    from_json(j, result);
    ASSERT_EQ(result["nums"].size(), static_cast<size_t>(3), "Nums size should be 3");
    ASSERT_EQ(result["more"][1], 5, "Value should be 5");
...
TEST_CASE(json_lite_array)
{
    ...
    from_json(j, result);
    ASSERT_EQ(result[0], 10, "First element should be 10");
    ASSERT_EQ(result[2], 30, "Last element should be 30");
...
TEST_CASE(json_lite_unordered_set)
{
    ...
    from_json(j, result);
    ASSERT_EQ(result.size(), s.size(), "Size should match");
...
TEST_CASE(json_lite_unordered_map)
{
    ...
    from_json(j, result);
    ASSERT_EQ(result.size(), m.size(), "Size should match");
...
TEST_CASE(json_lite_deque)
{
    ...
    from_json(j, result);
    ASSERT_EQ(result.size(), d.size(), "Size should match");
...
TEST_CASE(json_lite_list)
{
    ...
    std::list<int> result;
    from_json(j, result);
    ASSERT_EQ(result.size(), lst.size(), "Size should match");
...
TEST_CASE(json_lite_string_view)
{
    ...
    std::string result;
    from_json(j, result);
    ASSERT_EQ(result, "test string", "Value should match");
...
TEST_CASE(json_lite_optional)
{
    SUBTEST("optional with value") {
        ...
        ASSERT_TRUE(j.is_int(), "Optional int should be int");
    ...
    SUBTEST("optional without value") {
        std::optional<int> opt;
        JsonValue j = to_json(opt);
        ASSERT_TRUE(j.is_null(), "Empty optional should be null");
        std::optional<int> result;
        from_json(j, result);
        ASSERT_FALSE(result.has_value(), "Result should not have value");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_tuples_pairs)
{
    SUBTEST("pair<int, string>") {
        ...
        ASSERT_TRUE(j.is_array(), "Pair should be array");
        std::pair<int, std::string> result;
        from_json(j, result);
        ASSERT_EQ(result.first, 42, "First should be 42");
        ASSERT_EQ(result.second, "answer", "Second should be answer");
    }
    END_SUBTEST
    
    SUBTEST("tuple<int, double, string>") {
        std::tuple<int, double, std::string> t = {1, 2.5, "three"};
        JsonValue j = to_json(t);
        ASSERT_TRUE(j.is_array(), "Tuple should be array");
        std::tuple<int, double, std::string> result;
        from_json(j, result);
        ASSERT_EQ(std::get<0>(result), 1, "First should be 1");
        ASSERT_CLOSE(std::get<1>(result), 2.5, "Second should be 2.5");
        ASSERT_EQ(std::get<2>(result), "three", "Third should be three");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_pair_nested)
{
    ...
    from_json(j, result);
    ASSERT_EQ(result.first, 10, "First should be 10");
    ASSERT_EQ(result.second.size(), static_cast<size_t>(3), "Vector size should be 3");
...
TEST_CASE(json_lite_tuple_large)
{
    ...
    from_json(j, result);
    ASSERT_EQ(std::get<0>(result), 1, "Element 0 should be 1");
    ASSERT_EQ(std::get<4>(result), 5, "Element 4 should be 5");
...
TEST_CASE(json_lite_complex_struct)
{
    ...
    ASSERT_EQ(result.name, "Alice", "Name should be Alice");
    ASSERT_EQ(result.age, 30, "Age should be 30");
    ASSERT_EQ(result.hobbies.size(), static_cast<size_t>(3), "Should have 3 hobbies");
...
TEST_CASE(json_lite_optional_fields)
{
    ...
    ASSERT_EQ(result.port, 9000, "Port should be 9000");
    ASSERT_TRUE(result.timeout.has_value(), "Timeout should have value");
    ASSERT_EQ(*result.timeout, 30, "Timeout should be 30");
...
TEST_CASE(json_lite_intrusive_serialization)
{
    ...
    ASSERT_EQ(result.secret(), 42, "Secret should be 42");
    ASSERT_EQ(result.code(), "secret", "Code should be secret");
...
TEST_CASE(json_lite_nested_structs)
{
    ...
    ASSERT_EQ(result.position.x, 5, "x should be 5");
    ASSERT_EQ(result.position.y, 10, "y should be 10");
    ASSERT_EQ(result.label, "point1", "Label should be point1");
...
TEST_CASE(json_lite_complex_nested)
{
    ...
    ASSERT_EQ(result.scores.size(), static_cast<size_t>(2), "Should have 2 scores");
    ASSERT_EQ(result.points.size(), static_cast<size_t>(2), "Should have 2 points");
    ASSERT_TRUE(result.description.has_value(), "Description should have value");
...
TEST_CASE(json_lite_deep_hierarchy)
{
    ...
    ASSERT_EQ(result.name, "TechCorp", "Company name should match");
    ASSERT_EQ(result.departments.size(), static_cast<size_t>(1), "Should have 1 department");
    ASSERT_EQ(result.departments[0].employees[0].name, "John Doe", "Employee name should match");
...
TEST_CASE(json_lite_parser_basic)
{
    ...
    SUBTEST("parse true") {
        ...
        ASSERT_TRUE(j.is_bool(), "Should parse bool");
        ASSERT_EQ(std::get<bool>(j), true, "Should be true");
    }
    END_SUBTEST
    
    SUBTEST("parse false") {
        JsonValue j = parse_json("false");
        ASSERT_EQ(std::get<bool>(j), false, "Should be false");
    }
    END_SUBTEST
    
    SUBTEST("parse number") {
        JsonValue j = parse_json("42");
        ASSERT_TRUE(j.is_int(), "Should parse int");
    ...
    SUBTEST("parse string") {
        ...
        ASSERT_TRUE(j.is_string(), "Should parse string");
        ASSERT_EQ(std::get<std::string>(j), "hello", "Should be hello");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_parser_containers)
{
    SUBTEST("parse array") {
        ...
        ASSERT_EQ(arr.size(), static_cast<size_t>(3), "Array should have 3 elements");
    }
    END_SUBTEST
    
    SUBTEST("parse object") {
        JsonValue j = parse_json(R"({"key": "value"})");
        ASSERT_TRUE(j.is_object(), "Should parse object");
        const auto& obj = std::get<JsonObject>(j);
        ASSERT_EQ(obj.size(), static_cast<size_t>(1), "Object should have 1 key");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_parser_edge_cases)
{
    SUBTEST("empty array") {
        ...
        ASSERT_TRUE(std::get<JsonArray>(j).empty(), "Array should be empty");
    }
    END_SUBTEST
    
    SUBTEST("empty object") {
        JsonValue j = parse_json("{}");
        ASSERT_TRUE(j.is_object(), "Should parse empty object");
        ASSERT_TRUE(std::get<JsonObject>(j).empty(), "Object should be empty");
    }
    END_SUBTEST
    
    SUBTEST("whitespace handling") {
        JsonValue j = parse_json("  \n\t  42  \n\t  ");
        ASSERT_TRUE(j.is_int(), "Should handle whitespace");
        ASSERT_EQ(std::get<int64_t>(j), static_cast<int64_t>(42), "Should be 42");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_parser_numbers)
{
    ...
    SUBTEST("floating point") {
        ...
        ASSERT_TRUE(j.is_number(), "Should be number");
        ASSERT_CLOSE(std::get<double>(j), 3.14, "Should be 3.14");
    }
    END_SUBTEST
    
    SUBTEST("scientific notation") {
        JsonValue j = parse_json("1.5e10");
        ASSERT_TRUE(j.is_number(), "Should be number");
        ASSERT_CLOSE(std::get<double>(j), 1.5e10, "Should be 1.5e10");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_parser_strings)
{
    ...
    SUBTEST("escaped backslash") {
        JsonValue j = parse_json(R"("C:\\path\\file")");
        std::string result = std::get<std::string>(j);
        ASSERT_TRUE(result.find("\\\\") != std::string::npos || result.find("\\") != std::string::npos, 
...
TEST_CASE(json_lite_parser_nested)
{
    ...
    ASSERT_TRUE(j.is_object(), "Should parse nested structure");
    
    const auto& obj = std::get<JsonObject>(j);
    ASSERT_TRUE(obj.count("array") > 0, "Should have array key");
    ASSERT_TRUE(obj.count("object") > 0, "Should have object key");
...
TEST_CASE(json_lite_parser_errors)
{
    ...
    SUBTEST("unclosed array") {
        ASSERT_THROWS(parse_json("[1, 2, 3"), std::runtime_error, "Should throw on unclosed array");
    }
    END_SUBTEST
    
    SUBTEST("unclosed object") {
        ASSERT_THROWS(parse_json(R"({"key": "value")"), std::runtime_error, "Should throw on unclosed object");
    }
    END_SUBTEST
    
    SUBTEST("trailing comma") {
        ASSERT_THROWS(parse_json("[1, 2,]"), std::runtime_error, "Should throw on trailing comma");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_parser_literals)
{
    ...
    SUBTEST("false literal") {
        JsonValue j = parse_json("false");
        ASSERT_FALSE(std::get<bool>(j), "Should be false");
    }
    END_SUBTEST
    
    SUBTEST("null literal") {
        JsonValue j = parse_json("null");
        ASSERT_TRUE(j.is_null(), "Should be null");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_pretty_print)
{
    ...
    ASSERT_TRUE(pretty.length() > compact.length(), "Pretty print should be longer");
...
TEST_CASE(json_lite_numeric_precision)
{
    SUBTEST("default precision") {
        ...
        ASSERT_TRUE(!json.empty(), "Should serialize with default precision");
    }
    END_SUBTEST
    
    SUBTEST("custom precision") {
        double val = 3.141592653589793;
        std::string json2 = to_json_string<double, Precision2>(val);
        std::string json8 = to_json_string<double, Precision8>(val);
        ASSERT_TRUE(json2.length() < json8.length(), "Lower precision should be shorter");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_file_io)
{
    ...
    ASSERT_EQ(loaded.x, 100, "x should be 100");
    ASSERT_EQ(loaded.y, 200, "y should be 200");
...
TEST_CASE(json_lite_file_io_complex)
{
    ...
    ASSERT_EQ(loaded.port, 8080, "Port should be 8080");
    ASSERT_EQ(loaded.host, "localhost", "Host should be localhost");
    ASSERT_EQ(loaded.allowed_ips.size(), static_cast<size_t>(2), "Should have 2 IPs");
...
TEST_CASE(json_lite_roundtrip_all_types)
{
    SUBTEST("int round-trip") {
        ...
        ASSERT_EQ(result, val, "Int should round-trip");
    }
    END_SUBTEST
    
    SUBTEST("double round-trip") {
        double val = 3.14159;
        std::string json = to_json_string(val);
        double result = from_json_string<double>(json);
        ASSERT_CLOSE(result, val, "Double should round-trip");
    }
    END_SUBTEST
    
    SUBTEST("string round-trip") {
        std::string val = "test string";
        std::string json = to_json_string(val);
        std::string result = from_json_string<std::string>(json);
        ASSERT_EQ(result, val, "String should round-trip");
    }
    END_SUBTEST
...
TEST_CASE(json_lite_roundtrip_maps)
{
    ...
    ASSERT_EQ(result.size(), m.size(), "Map size should match");
    ASSERT_EQ(result["a"], 1, "Value should be 1");
...
TEST_CASE(json_lite_large_data)
{
    ...
    ASSERT_TRUE(json.length() > 10000, "Large vector JSON should be substantial");
...
TEST_CASE(json_lite_large_strings)
{
    ...
    ASSERT_TRUE(json.length() > 100000, "Large string JSON should be substantial");
...
TEST_CASE(json_lite_large_map)
{
    ...
    JsonValue j = to_json(large_map);
    std::string json = to_json_string(j);
    ASSERT_TRUE(json.length() > 5000, "Large map JSON should be substantial");
...
TEST_CASE(json_lite_depth_limit_parse)
{
    ...
    ASSERT_THROWS(parse_json(deep_json), std::runtime_error, "Should throw on exceeding parse depth");
    return true;
}
...
TEST_CASE(json_lite_depth_limit_dump)
{
    ...
    ASSERT_THROWS(to_json_string(deep_array), std::runtime_error, "Should throw on exceeding dump depth");
    return true;
}
...
TEST_CASE(json_lite_range_checks)
{
    SUBTEST("int overflow") {
        JsonValue j = static_cast<int64_t>(3000000000LL);
        int result = 0;
        ASSERT_THROWS(from_json(j, result), std::runtime_error, "Should throw on int overflow");
    }
    END_SUBTEST
    
    SUBTEST("unsigned negative") {
        JsonValue j = static_cast<int64_t>(-1);
        unsigned int result = 0;
...
TEST_CASE(json_lite_better_error_messages)
{
    ...
    catch (const std::exception& e) 
    {
        ...
        ASSERT_TRUE(!msg.empty(), "Error message should not be empty");
    }
...
TEST_CASE(json_lite_param_helpers)
{
    ...
    ASSERT_EQ(loaded.x, 42, "x should be 42");
    ASSERT_EQ(loaded.y, 84, "y should be 84");
...
TEST_CASE(json_lite_position_in_errors)
{
    ...
    {
        std::string msg = e.what();
        ASSERT_TRUE(!msg.empty(), "Error should have position info");
    }
...
TEST_CASE(json_lite_error_messages_comprehensive)
{
    SUBTEST("type mismatch") {
        ...
        {
            std::string msg = e.what();
            ASSERT_TRUE(msg.find("type") != std::string::npos || msg.find("Type") != std::string::npos, 
...
TEST_CASE(json_lite_field_limit)
{
    ...
    ASSERT_EQ(result.f1, 1, "f1 should be 1");
    ASSERT_EQ(result.f50, 50, "f50 should be 50");
...
TEST_CASE(json_lite_bug2_name_collision)
{
    ...
    ASSERT_EQ(result_a.value, 42, "TypeA value should be 42");
    ASSERT_CLOSE(result_b.value, 3.14, "TypeB value should be 3.14");
...
TEST_CASE(json_lite_bug2_collision_prevention)
{
    ...
    ASSERT_EQ(u_result.name, "Alice", "User name should be Alice");
    ASSERT_EQ(p_result.name, "Widget", "Product name should be Widget");
    ASSERT_EQ(o_result.name, "Item", "Order name should be Item");
...
TEST_CASE(json_lite_numeric_formatting)
{
    ...
    ASSERT_TRUE(!json_std.empty(), "Standard formatting");
    ASSERT_TRUE(!json_sci.empty(), "Scientific formatting");
    ASSERT_TRUE(!json_fix.empty(), "Fixed formatting");
...
TEST_CASE(json_lite_bug4_error_context)
{
    ...
    {
        std::string msg = e.what();
        ASSERT_TRUE(!msg.empty(), "Error context should exist");
    }
...
TEST_CASE(json_lite_bug5_fixed_arrays)
{
    ...
    ASSERT_EQ(out.values[0], 1, "First value");
    ASSERT_EQ(out.values[2], 3, "Third value");
    ASSERT_CLOSE(out.coords[0], 3.14, "First coord");
    ASSERT_CLOSE(out.coords[1], 2.71, "Second coord");
...
TEST_CASE(json_lite_bug6_policy_incompatibility)
{
    ...
    ASSERT_TRUE(policy_respected, "Custom policies must be respected by macro-generated functions");
...
TEST_CASE(json_lite_bug6_policy_fix_verification)
{
    ...
    ASSERT_TRUE(json2.length() < json4.length(), "Higher precision should produce longer output");
    ASSERT_TRUE(json4.length() < json8.length(), "Higher precision should produce longer output");
    ASSERT_TRUE(json8.length() < json16.length(), "Higher precision should produce longer output");
...
TEST_CASE(jsonc_line_comments)
{
    ...
    ASSERT_TRUE(j.is_object(), "Should parse object with line comments");
...
TEST_CASE(jsonc_block_comments)
{
    ...
    ASSERT_TRUE(j.is_object(), "Should parse object with block comments");
...
TEST_CASE(jsonc_comment_edge_cases)
{
    SUBTEST("comment with quotes") {
        ...
        JsonValue j = parse_json<ConfigJsonPolicy>(json);
        ASSERT_TRUE(j.is_object(), "Should handle comment with quotes");
    }
    END_SUBTEST
    
    SUBTEST("comment with escaped chars") {
        std::string json = R"({
            "data": "test"
        })";
        JsonValue j = parse_json<ConfigJsonPolicy>(json);
        ASSERT_TRUE(j.is_object(), "Should handle comment with escaped chars");
    }
    END_SUBTEST
...
TEST_CASE(jsonc_strict_mode_rejection)
{
    ...
    ASSERT_THROWS(parse_json<StandardJsonPolicy>(json), std::runtime_error, "Standard policy should reject comments");
    return true;
}
...
TEST_CASE(utf8_european_chars_escaped)
{
    ...
    std::string result = from_json_string<std::string>(json);
    ASSERT_EQ(result, text, "Should round-trip European characters");
...
TEST_CASE(utf8_asian_chars_escaped)
{
    ...
    std::string result = from_json_string<std::string>(json);
    ASSERT_EQ(result, text, "Should round-trip Asian characters");
...
TEST_CASE(utf8_emoji_surrogate_pairs)
{
    ...
    std::string result = from_json_string<std::string>(json);
    ASSERT_EQ(result, text, "Should round-trip emoji with surrogate pairs");
...
TEST_CASE(utf8_raw_passthrough)
{
    ...
    std::string result = from_json_string<std::string>(json);
    ASSERT_EQ(result, text, "Should round-trip raw UTF-8");
...
TEST_CASE(utf8_mixed_content)
{
    ...
    ASSERT_EQ(result.european_text, data.european_text, "European text should round-trip");
    ASSERT_EQ(result.asian_text, data.asian_text, "Asian text should round-trip");
    ASSERT_EQ(result.emoji_text, data.emoji_text, "Emoji text should round-trip");
    ASSERT_EQ(result.mixed_text, data.mixed_text, "Mixed text should round-trip");
...
TEST_CASE(numeric_margin_removed_max_int64)
{
    ...
    int64_t result = 0;
    from_json(j, result);
    ASSERT_EQ(result, LLONG_MAX, "LLONG_MAX should deserialize successfully");
...
TEST_CASE(numeric_all_primitives_from_double)
{
    SUBTEST("short from fractional") {
        JsonValue j = 3.14;
        short result = 0;
        ASSERT_THROWS(from_json(j, result), std::runtime_error, "Should throw fractional part error");
    }
    END_SUBTEST
    
    SUBTEST("signed char from fractional") {
        JsonValue j = 2.71;
    ...
    SUBTEST("unsigned char from fractional") {
        JsonValue j = 1.5;
    ...
    SUBTEST("unsigned short from fractional") {
        JsonValue j = 4.2;
...
TEST_CASE(numeric_unsigned_negative_all_types)
{
    SUBTEST("unsigned int from negative") {
        JsonValue j = static_cast<int64_t>(-1);
        unsigned int result = 0;
        ASSERT_THROWS(from_json(j, result), std::runtime_error, "Should throw negative error");
    }
    END_SUBTEST
    
    SUBTEST("unsigned char from negative") {
    ...
    SUBTEST("unsigned short from negative") {
...
TEST_CASE(infinity_compat_acceptance)
{
    ...
    const auto& obj = std::get<JsonObject>(j);
    double val = from_json<double>(obj.at("value"));
    ASSERT_TRUE(std::isinf(val) && val > 0, "Value should be positive infinity");
...
TEST_CASE(negative_infinity_compat)
{
    ...
    const auto& obj = std::get<JsonObject>(j);
    double val = from_json<double>(obj.at("value"));
    ASSERT_TRUE(std::isinf(val) && val < 0, "Value should be negative infinity");
...
TEST_CASE(container_empty_vector)
{
    ...
    std::vector<int> vec;
    from_json(arr, vec);
    ASSERT_TRUE(vec.empty(), "Empty array should produce empty vector");
...
TEST_CASE(container_empty_set)
{
    ...
    std::set<int> s;
    from_json(arr, s);
    ASSERT_TRUE(s.empty(), "Empty array should produce empty set");
...
TEST_CASE(container_empty_deque)
{
    ...
    std::deque<int> d;
    from_json(arr, d);
    ASSERT_TRUE(d.empty(), "Empty array should produce empty deque");
...
TEST_CASE(save_params_with_backup)
{
    ...
    ASSERT_TRUE(std::ifstream("backup_test.json").good(), "Main file should exist");
    ASSERT_TRUE(std::ifstream("backup_test.json.bak").good(), "Backup file should exist");
    
    Point loaded_main = load_params<Point>("backup_test.json");
    ASSERT_EQ(loaded_main.x, 30, "Main file should have new data");
    
    Point loaded_backup = load_params<Point>("backup_test.json.bak");
    ASSERT_EQ(loaded_backup.x, 10, "Backup should have old data");
...
TEST_CASE(save_params_with_custom_backup_suffix)
{
    ...
    ASSERT_TRUE(std::ifstream("custom_backup.json.old").good(), "Custom backup should exist");
...
TEST_CASE(json_pointer_basic_navigation)
{
    SUBTEST("object navigation") {
        ...
        ASSERT_EQ(from_json<int>(port), 5432, "Should navigate to nested port");
        
        const JsonValue& host = query_json_pointer(doc, "/database/host");
        ASSERT_EQ(from_json<std::string>(host), "localhost", "Should navigate to nested host");
    }
    END_SUBTEST
    ...
    SUBTEST("array navigation") {
        ...
        ASSERT_EQ(from_json<std::string>(first), "primary", "Should get first element");
        
        const JsonValue& second = query_json_pointer(doc, "/servers/1");
        ASSERT_EQ(from_json<std::string>(second), "backup", "Should get second element");
        
        const JsonValue& third = query_json_pointer(doc, "/servers/2");
        ASSERT_EQ(from_json<std::string>(third), "tertiary", "Should get third element");
    }
    END_SUBTEST
    ...
    SUBTEST("root document") {
        ...
        ASSERT_TRUE(root.is_object(), "Empty pointer should return root");
    }
    END_SUBTEST
...
TEST_CASE(json_pointer_escape_sequences)
{
    SUBTEST("tilde escape ~0") {
        ...
        ASSERT_EQ(from_json<std::string>(val), "value1", "~0 should decode to ~");
    }
    END_SUBTEST
    ...
    SUBTEST("forward slash escape ~1") {
        ...
        ASSERT_EQ(from_json<std::string>(val), "value2", "~1 should decode to /");
    }
    END_SUBTEST
    ...
    SUBTEST("multiple escapes") {
        ...
        ASSERT_EQ(from_json<std::string>(val), "value3", "Should handle multiple escapes");
    }
    END_SUBTEST
...
TEST_CASE(json_pointer_type_safe)
{
    ...
    SUBTEST("query_json_as with primitives") {
        int port = query_json_as<int>(doc, "/database/port");
        ASSERT_EQ(port, 5432, "Should extract int");
        
        std::string host = query_json_as<std::string>(doc, "/database/host");
        ASSERT_EQ(host, "localhost", "Should extract string");
        
        bool enabled = query_json_as<bool>(doc, "/database/enabled");
        ASSERT_TRUE(enabled, "Should extract bool");
    }
    END_SUBTEST
    
    SUBTEST("query_json_as with containers") {
        auto servers = query_json_as<std::vector<std::string>>(doc, "/servers");
        ASSERT_EQ(servers.size(), 2u, "Should extract vector");
        ASSERT_EQ(servers[0], "server1", "First server correct");
        ASSERT_EQ(servers[1], "server2", "Second server correct");
    }
    END_SUBTEST
...
TEST_CASE(json_pointer_mutable)
{
    ...
    SUBTEST("modify nested value") {
        ...
        ASSERT_EQ(new_port, 9000, "Should modify nested value");
    }
    END_SUBTEST
    ...
    SUBTEST("modify array element") {
        ...
        ASSERT_EQ(new_elem, 42, "Should modify array element");
    }
    END_SUBTEST
...
TEST_CASE(json_pointer_complex_nested)
{
    ...
    SUBTEST("deep nested navigation") {
        std::string name = query_json_as<std::string>(
            doc, "/level1/level2/level3/data/1/name"
        );
        ASSERT_EQ(name, "item2", "Should navigate deeply");
        
        int value = query_json_as<int>(
            doc, "/level1/level2/level3/data/2/value"
        );
        ASSERT_EQ(value, 300, "Should extract nested value");
    }
    END_SUBTEST
...
TEST_CASE(json_pointer_errors)
{
    ...
    SUBTEST("key not found") {
        JsonValue doc = parse_json(R"({"key": "value"})");
        ASSERT_THROWS(
            query_json_pointer(doc, "/nonexistent"),
            std::runtime_error,
    ...
    SUBTEST("invalid array index") {
        JsonValue doc = parse_json(R"({"arr": [1, 2, 3]})");
        ASSERT_THROWS(
            query_json_pointer(doc, "/arr/abc"),
            std::runtime_error,
    ...
    SUBTEST("leading zero in array index") {
        JsonValue doc = parse_json(R"({"arr": [1, 2, 3]})");
        ASSERT_THROWS(
            query_json_pointer(doc, "/arr/01"),
            std::runtime_error,
    ...
    SUBTEST("navigate into scalar") {
        JsonValue doc = parse_json(R"({"value": 42})");
        ASSERT_THROWS(
            query_json_pointer(doc, "/value/nested"),
            std::runtime_error,
    ...
    SUBTEST("incomplete escape sequence") {
        JsonValue doc = parse_json(R"({"key~": "value"})");
        ASSERT_THROWS(
            query_json_pointer(doc, "/key~"),
            std::runtime_error,
            "Should reject incomplete escape"
        );
    }
    END_SUBTEST
    
    SUBTEST("invalid escape sequence") {
        JsonValue doc = parse_json(R"({"key": "value"})");
        ASSERT_THROWS(
            query_json_pointer(doc, "/key~2"),
            std::runtime_error,
...
TEST_CASE(json_pointer_edge_cases)
{
    SUBTEST("empty object key") {
        ...
        ASSERT_EQ(val, "empty_key", "Should handle empty key");
    }
    END_SUBTEST
    
    SUBTEST("zero array index") {
        JsonValue doc = parse_json(R"({"arr": [42]})");
        int val = query_json_as<int>(doc, "/arr/0");
        ASSERT_EQ(val, 42, "Should handle zero index");
    }
    END_SUBTEST
    
    SUBTEST("numeric object keys") {
        JsonValue doc = parse_json(R"({"0": "zero", "1": "one"})");
        std::string val0 = query_json_as<std::string>(doc, "/0");
        ASSERT_EQ(val0, "zero", "Should navigate numeric keys");
        
        std::string val1 = query_json_as<std::string>(doc, "/1");
        ASSERT_EQ(val1, "one", "Should navigate numeric keys");
    }
    END_SUBTEST
...
TEST_CASE(json_pointer_with_structs)
{
    SUBTEST("extract custom struct from pointer") {
        ...
        ASSERT_EQ(db.host, "localhost", "Should extract struct");
        ASSERT_EQ(db.port, 5432, "Should extract struct field");
        ASSERT_TRUE(db.timeout.has_value(), "Should extract optional");
        ASSERT_EQ(*db.timeout, 30, "Should extract optional value");
    }
    END_SUBTEST
...
TEST_CASE(json_pointer_rfc6901_examples)
{
    ...
    SUBTEST("RFC 6901 test cases") {
        const JsonValue& root = query_json_pointer(doc, "");
        ASSERT_TRUE(root.is_object(), "Empty string = whole document");
        
        auto foo = query_json_as<std::vector<std::string>>(doc, "/foo");
        ASSERT_EQ(foo[0], "bar", "/foo correct");
        
        std::string bar = query_json_as<std::string>(doc, "/foo/0");
        ASSERT_EQ(bar, "bar", "/foo/0 correct");
        
        int64_t empty_key = query_json_as<int64_t>(doc, "/");
        ASSERT_EQ(empty_key, 0, "Empty key correct");
        
        int64_t slash_key = query_json_as<int64_t>(doc, "/a~1b");
        ASSERT_EQ(slash_key, 1, "a/b with ~1 escape correct");
        
        int64_t tilde_key = query_json_as<int64_t>(doc, "/m~0n");
        ASSERT_EQ(tilde_key, 8, "m~n with ~0 escape correct");
    }
    END_SUBTEST
...
TEST_CASE(malformed_missing_comma)
{
    ...
    SIMPLE_ASSERT(r1, "missing comma in array");
    
    bool r2 = malformed_expect_parse_fail("{\"a\":1 \"b\":2}", "missing comma in object must fail");
    SIMPLE_ASSERT(r2, "missing comma in object");
    return true;
}
...
TEST_CASE(malformed_trailing_comma_array)
{
    ...
    SIMPLE_ASSERT(r1, "trailing comma array");
    
    bool r2 = malformed_expect_parse_fail("[,1,2]", "leading comma array must fail");
    SIMPLE_ASSERT(r2, "leading comma array");
    return true;
}
...
TEST_CASE(malformed_trailing_comma_object)
{
    ...
    SIMPLE_ASSERT(r1, "trailing comma object");
    return true;
}
...
TEST_CASE(fuzz_ints)
{
    ...
    for (int i = 0; i < 2000; ++i)
    {
        ...
        int result = 0;
        SIMPLE_ASSERT(fuzz_roundtrip(v, result), "Fuzz int roundtrip failed");
        SIMPLE_ASSERT(result == v, "Fuzz int mismatch");
    }
...
TEST_CASE(fuzz_int64)
{
    ...
    for (int i = 0; i < 2000; ++i)
    {
        ...
        SIMPLE_ASSERT(fuzz_roundtrip(v, result), "Fuzz int64 roundtrip failed");
        SIMPLE_ASSERT(result == v, "Fuzz int64 mismatch");
    }
...
TEST_CASE(fuzz_doubles)
{
    ...
    for (int i = 0; i < 2000; ++i)
    {
        ...
        double result = 0.0;
        SIMPLE_ASSERT(fuzz_roundtrip(v, result), "Fuzz double roundtrip failed");
        SIMPLE_ASSERT(std::fabs(result - v) < 1e-9, "Fuzz double mismatch");
    }
...
TEST_CASE(fuzz_strings)
{
    ...
    for (int i = 0; i < 2000; ++i)
    {
        ...
        std::string result;
        SIMPLE_ASSERT(fuzz_roundtrip(v, result), "Fuzz string roundtrip failed");
        SIMPLE_ASSERT(result == v, "Fuzz string mismatch");
    }
...
TEST_CASE(fuzz_vector_int)
{
    ...
    for (int iter = 0; iter < 500; ++iter)
    {
        ...
        std::vector<int> result;
        SIMPLE_ASSERT(fuzz_roundtrip(v, result), "Fuzz vector<int> roundtrip failed");
        SIMPLE_ASSERT(result == v, "Fuzz vector<int> mismatch");
    }
...
TEST_CASE(fuzz_map_string_int)
{
    ...
    for (int iter = 0; iter < 300; ++iter)
    {
        ...
        std::map<std::string, int> result;
        SIMPLE_ASSERT(fuzz_roundtrip(m, result), "Fuzz map<string,int> roundtrip failed");
        SIMPLE_ASSERT(result == m, "Fuzz map<string,int> mismatch");
    }
...
TEST_CASE(fuzz_nested_structures)
{
    ...
    for (int iter = 0; iter < 200; ++iter)
    {
        ...
        SIMPLE_ASSERT(fuzz_roundtrip(v, result), "Fuzz nested roundtrip failed");
        SIMPLE_ASSERT(result == v, "Fuzz nested vector<map<string,int>> mismatch");
    }
...
bool test_JsonLite()
{
    ...
    // Malformed input tests
    RUN_TEST_NS(runner, jsonlite, malformed_missing_comma);
    RUN_TEST_NS(runner, jsonlite, malformed_trailing_comma_array);
    RUN_TEST_NS(runner, jsonlite, malformed_trailing_comma_object);
    RUN_TEST_NS(runner, jsonlite, malformed_unquoted_key);
    RUN_TEST_NS(runner, jsonlite, malformed_unterminated_string);
    RUN_TEST_NS(runner, jsonlite, malformed_numbers);
    RUN_TEST_NS(runner, jsonlite, malformed_string_escapes);
    RUN_TEST_NS(runner, jsonlite, malformed_structure);
    RUN_TEST_NS(runner, jsonlite, malformed_literals);
    RUN_TEST_NS(runner, jsonlite, malformed_deep_nesting_stress);
    RUN_TEST_NS(runner, jsonlite, malformed_unicode);
    
    // Fuzz tests
    RUN_TEST_NS(runner, jsonlite, fuzz_ints);
    RUN_TEST_NS(runner, jsonlite, fuzz_int64);
    RUN_TEST_NS(runner, jsonlite, fuzz_doubles);
    RUN_TEST_NS(runner, jsonlite, fuzz_strings);
    RUN_TEST_NS(runner, jsonlite, fuzz_vector_int);
    RUN_TEST_NS(runner, jsonlite, fuzz_map_string_int);
    RUN_TEST_NS(runner, jsonlite, fuzz_nested_structures);
    
    // Encode/decode benchmarks
    RUN_TEST_NS(runner, jsonlite, encode_decode_benchmark_vector_int);
    RUN_TEST_NS(runner, jsonlite, encode_decode_benchmark_map_string_int);
    RUN_TEST_NS(runner, jsonlite, encode_decode_benchmark_nested);
