...
#define RUN_AND_RECORD(test_func) results.push_back({#test_func, test_func()})
    ...
    RUN_AND_RECORD(test_TensorLayout);
    RUN_AND_RECORD(test_TensorView);
    ...
    RUN_AND_RECORD(test_TensorContractions);
    ...
    RUN_AND_RECORD(test_TensorRanked);
    RUN_AND_RECORD(test_TensorMaterialization);
    RUN_AND_RECORD(test_TensorOwnerLifetime);
