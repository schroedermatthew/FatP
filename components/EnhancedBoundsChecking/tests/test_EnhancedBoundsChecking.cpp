...
FATP_META:
  ...
  file_role: test
  path: components/EnhancedBoundsChecking/tests/test_EnhancedBoundsChecking.cpp
  layer: Testing
...
{
    std::cout << colors::cyan() << "\n[TEST] Basic Bounds Checking" << colors::reset() << std::endl;

    // Valid index should not throw
    try
    {
        bounds_check(5, 0, 10, "Test index");
        std::cout << colors::green() << "[OK] Valid index passed" << colors::reset() << std::endl;
    }
    catch (...)
    {
    ...
    catch (const std::out_of_range& e)
    {
        ...
        FATP_ASSERT_TRUE(msg.find("Test index") != std::string::npos, "Error message should contain context");
        FATP_ASSERT_TRUE(msg.find("15") != std::string::npos, "Error message should contain index");
        std::cout << colors::blue() << "  Error message: " << e.what() << colors::reset() << std::endl;
    }
    FATP_ASSERT_TRUE(threw, "Out of bounds index should throw");

    std::cout << colors::green() << "[OK] Basic bounds checking passed" << colors::reset() << std::endl;
    return true;
}
...
{
    std::cout << colors::cyan() << "\n[TEST] Debug-Only Bounds Checking" << colors::reset() << std::endl;
    ...
    try
    {
        ...
        std::cout << colors::blue() << "  Release build: check compiled out" << colors::reset() << std::endl;
    }
    catch (...)
    {
    ...
    std::cout << colors::blue() << "  Debug build: check active" << colors::reset() << std::endl;
#endif

    std::cout << colors::green() << "[OK] Debug-only bounds checking passed" << colors::reset() << std::endl;
    return true;
}
...
{
    std::cout << colors::cyan() << "\n[TEST] Container Bounds Checking" << colors::reset() << std::endl;
    ...
    try
    {
        ...
        std::cout << colors::green() << "[OK] Valid container access passed" << colors::reset() << std::endl;
    }
    catch (...)
    {
    ...
    {
        threw = true;
        std::cout << colors::blue() << "  Error: " << e.what() << colors::reset() << std::endl;
    }
    FATP_ASSERT_TRUE(threw, "Invalid container access should throw");

    std::cout << colors::green() << "[OK] Container bounds checking passed" << colors::reset() << std::endl;
    return true;
}
...
{
    std::cout << colors::cyan() << "\n[TEST] 2D Bounds Checking" << colors::reset() << std::endl;
    ...
    try
    {
        ...
        std::cout << colors::green() << "[OK] Valid 2D access passed" << colors::reset() << std::endl;
    }
    catch (...)
    {
    ...
    catch (const std::out_of_range& e)
    {
        threw = true;
        std::string msg = e.what();
        FATP_ASSERT_TRUE(msg.find("(15, 10)") != std::string::npos, "Error should show indices");
        FATP_ASSERT_TRUE(msg.find("(10, 20)") != std::string::npos, "Error should show shape");
    }
    ...
    std::cout << colors::green() << "[OK] 2D bounds checking passed" << colors::reset() << std::endl;
    return true;
}
...
{
    std::cout << colors::cyan() << "\n[TEST] N-Dimensional Bounds Checking" << colors::reset() << std::endl;
    ...
    try
    {
        ...
        std::cout << colors::green() << "[OK] Valid ND access passed" << colors::reset() << std::endl;
    }
    catch (...)
    {
    ...
    catch (const std::out_of_range& e)
    {
        threw = true;
        std::string msg = e.what();
        FATP_ASSERT_TRUE(msg.find("dimension 1") != std::string::npos, "Error should identify problematic dimension");
    }
    FATP_ASSERT_TRUE(threw, "Out of bounds index should throw");

    std::cout << colors::green() << "[OK] ND bounds checking passed" << colors::reset() << std::endl;
    return true;
}
...
{
    std::cout << colors::cyan() << "\n[TEST] Range Validation" << colors::reset() << std::endl;
    ...
    try
    {
        ...
        std::cout << colors::green() << "[OK] Valid range passed" << colors::reset() << std::endl;
    }
    catch (...)
    {
    ...
    std::cout << colors::green() << "[OK] Range validation passed" << colors::reset() << std::endl;
    return true;
}
...
{
    std::cout << colors::cyan() << "\n[TEST] Slice Validation" << colors::reset() << std::endl;
    ...
    try
    {
        ...
        std::cout << colors::green() << "[OK] Valid slice passed" << colors::reset() << std::endl;
    }
    catch (...)
    {
    ...
    std::cout << colors::green() << "[OK] Slice validation passed" << colors::reset() << std::endl;
    return true;
}
...
{
    std::cout << colors::cyan() << "\n[TEST] Enforce-Based Bounds Checking" << colors::reset() << std::endl;

    // Valid bounds with enforce
    try
    {
        enforce_bounds(5, 0, 10, "Enforce test");
        std::cout << colors::green() << "[OK] Valid enforce bounds passed" << colors::reset() << std::endl;
    }
    catch (...)
    {
    ...
    {
        threw = true;
        std::cout << colors::blue() << "  Enforce error: " << e.what() << colors::reset() << std::endl;
    }
    FATP_ASSERT_TRUE(threw, "Enforce should throw on invalid bounds");

    std::cout << colors::green() << "[OK] Enforce-based bounds checking passed" << colors::reset() << std::endl;
    return true;
}
