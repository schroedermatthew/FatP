...
//
// Build:
//   g++ -std=c++20 -O3 -DNDEBUG -march=native benchmark_FloatingPointComparison.cpp -o bench_fp
//   cl /std:c++20 /O2 /DNDEBUG /EHsc benchmark_FloatingPointComparison.cpp /link advapi32.lib
//
...
FATP_META:
  ...
  file_role: benchmark
  path: components/FloatingPointComparison/benchmarks/benchmark_FloatingPointComparison.cpp
  layer: Testing
  namespace: fat_p
