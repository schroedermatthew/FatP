...
FATP_META:
  ...
  component: StrongId
  file_role: test
  path: components/StrongId/tests/test_StrongId.cpp
  layer: Testing
  namespace: fat_p
...
{
    static_assert(concepts::strong_id_type<UserId>, "UserId should be a StrongId");
    static_assert(concepts::strong_id_type<ProductId>, "ProductId should be a StrongId");
    static_assert(!concepts::strong_id_type<int>, "int should not be a StrongId");
    static_assert(!concepts::strong_id_type<std::string>, "string should not be a StrongId");
    return true;
}
