...
//
// Build:
//   g++ -std=c++20 -O3 -DNDEBUG -march=native benchmark_SlotMap.cpp -o bench_sm
//   cl /std:c++20 /O2 /DNDEBUG /EHsc benchmark_SlotMap.cpp /link advapi32.lib
//
...
FATP_META:
  ...
  component: SlotMap
  file_role: benchmark
  path: components/SlotMap/benchmarks/benchmark_SlotMap.cpp
  layer: Testing
  namespace: fat_p
