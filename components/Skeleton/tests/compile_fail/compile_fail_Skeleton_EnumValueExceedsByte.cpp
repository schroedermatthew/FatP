...
FATP_META:
  ...
  component: Skeleton
  file_role: test
  path: components/Skeleton/tests/compile_fail/compile_fail_Skeleton_EnumValueExceedsByte.cpp
  layer: Testing
  namespace: fat_p
  summary: "Compile-fail test: Bone level enum values must fit in one byte"
