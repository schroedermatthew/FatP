...
//
// Build:
//   g++ -std=c++17 -O3 -DNDEBUG -march=native benchmark_SparseSet.cpp -o bench_ss
//   cl /std:c++17 /O2 /DNDEBUG /EHsc benchmark_SparseSet.cpp /link advapi32.lib
//
...
FATP_META:
  ...
  component: SparseSet
  file_role: benchmark
  path: benchmarks/benchmark_SparseSet.cpp
  namespace: fat_p
...
static void benchmark_core_operations(const std::vector<size_t>& sizes)
{
    ...
    for (size_t N : sizes)
    {
        ...
        std::vector<BenchCase> cases = {
            BenchCase::Insert, BenchCase::Contains, BenchCase::Erase, BenchCase::Iteration};
